    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-2xl ring-4 ring-purple-200 dark:ring-purple-900">
              <Image
                src="/sathi.jpeg"
          ...
          >
            ...
            >
              ...
              <motion.a
                href="#contact"
                className="px-8 py-3 border-2 border-purple-600 text-purple-600 dark:text-purple-400 dark:border-purple-400 rounded-full font-semibold hover:bg-purple-600 hover:text-white dark:hover:bg-purple-400 dark:hover:text-white transition-all"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                Get In Touch
